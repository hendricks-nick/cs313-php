    ...
    <body>
      ...
      <div class="bContainer">
        <div class="product">
          ...
          <button class="addCartBtn" type="button" onclick="addToCart(bbHoop)">Add To Cart</button>
        </div>
        <div class="product">
        ...
        <div class="product">
          ...
          <button class="addCartBtn" type="button" onclick="addToCart(rubik)">Add To Cart</button>
        </div>
        <div class="product">
          <img src="images/bloks.jpg" alt="bloks">
          <br>
          <div class="prodTitle">Building Bloks</div>
          <button class="addCartBtn" type="button" onclick="addToCart(bloks)">Add To Cart</button>
        </div>
        <div class="product">
          <img src="images/trike.jpg" alt="tricycle">
          <br>
          <div class="prodTitle">Tricycle</div>
          <button class="addCartBtn" type="button" onclick="addToCart(trike)">Add To Cart</button>
        </div>
        <div class="product">
          <img src="images/truck.jpg" alt="truck">
          <br>
          <div class="prodTitle">Toy Truck</div>
          <button class="addCartBtn" type="button" onclick="addToCart(truck)">Add To Cart</button>
        </div>
      </div>
    </body>
</html>
